...
public class Search {
    ...
    public static void main(String[] args) {
        ...
        printIntArray(array);
        System.out.println(
                String.format("Searching for element with value %d: index = %d", 6, Arrays.binarySearch(array, 6)));
        Arrays.sort(array);
        printIntArray(array);
        System.out.println(
                String.format("Searching for element with value %d: index = %d", 6, Arrays.binarySearch(array, 6)));
        ...
        printList(list);
        System.out.println(
                String.format("Searching for element with value %d: index = %d", 6, Collections.binarySearch(list, 6)));
        System.out.println();
        ...
        System.out.println(String.format("Searching for element with value %d: index = %d", 13,
                Collections.binarySearch(list, 13)));
        System.out.println(
                String.format("Searching for element with value %d: index = %d", 5, Collections.binarySearch(list, 5)));
