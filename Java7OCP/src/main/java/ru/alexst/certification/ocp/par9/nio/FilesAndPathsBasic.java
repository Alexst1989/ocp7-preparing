...
public class FilesAndPathsBasic {
    ...
    public static void main(String args[]) throws IOException, URISyntaxException {
        ...
        // C:\Users\Алексей\YandexDisk\Учеба\ПРОГРАММИРОВАНИЕ\Подготовка к OCP
        // Java 7\Workspace\Java7OCP
        Path pp = Paths.get("ocptestrelative");
        Path p6 = Paths.get("ocptestrelative", "file1.txt");

        // Creating file in relative path
        if (!Files.isDirectory(pp)) Files.createDirectory(pp); // If directory
                                                               // already
                                                               // exist's an
                                                               // exception will
                                                               // occur
        ...
        try {
            Files.createFile(p5);
            // if directory where you trying to create a file doesn't exists an
