...
public class Polymorphism {
    ...
    public static void main(String[] args) {
        ...
        // List<?> foo = new ArrayList<? extends Animal>(); //Compilation error !!!!!! You cannot use wildcard notation
        // in the object creation.
        // List<? extends Dog> cList = new ArrayList<Integer>(); //Compilation error !!!!!! You cannot assign an Integer
        // list to a reference that takes only a Dog
...
class AnimalDoctor {
    ...
    public static void holyShit(AbstractAnimal[] animalArray) {
        ...
        /*
         * But there IS no equivalent exception for generics because of type erasure! In other words, at runtime, the
         * JVM KNOWS the type of arrays, but does NOT know the type of a collection.
         */
        animalArray[0] = new Dog();
    }
    ...
    public static void checkAnimalWildcardSuper(List<? super Dog> dogList) {
        /*
         * Hey, compiler, please accept any List with a generic type that is of type Dog or a supertype of Dog. Nothing
         * lower in the inheritance tree can come in, but anything higher than Dog is okay.
         */
